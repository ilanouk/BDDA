...
public class DiskManager {
	...
	private static ArrayList<PageId> tabPageLibre = new ArrayList<PageId>(); // tableau qui stock la liste des pages
																				// libres
	PageId page;
	...
	public String afficherTab() { // Methode permettant d'afficher le tableau des pages libre afin de faciliter le
									// debuggage
		String tab = "";
